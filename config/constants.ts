...
export const AUDIO_MAP = {
  ...
  first_step: [
    "https://lz.qaiu.top/parser?url=https://sbcnm.lanzoum.com/icxPT3o4hrxe"
  ],
  zeritime: [
    "https://lz.qaiu.top/parser?url=https://sbcnm.lanzoum.com/iDz5u3msp04d"
  ],
  collab_star: [
    "https://lz.qaiu.top/parser?url=https://sbcnm.lanzoum.com/iMt4C3hvxkuf",
    "https://lz.qaiu.top/parser?url=https://sbcnm.lanzoum.com/icrY03dq4swh", // Backup: Parallel Daily (sp.)
    "https://cik07-cos.7moor-fs2.com/im/4d2c3f00-7d4c-11e5-af15-41bf63ae4ea0/fd991fcc1f737774/main.mp3" // Fallback to Main Theme if Star fails
  ]
};

...
const StoryEntryAnimation: React.FC<StoryEntryAnimationProps> = ({ onComplete, onTransitionStart, language, mode = 'full' }) => {
  ...
  }, [onComplete, onTransitionStart, mode]); // removed TIMINGS from deps
  ...
  return (
    <div className="fixed inset-0 z-[99999] bg-ash-black text-ash-light overflow-hidden flex items-center justify-center font-mono cursor-none">
      ...
      {stage === 3 && (
          <div className="absolute inset-0 bg-white animate-fade-in z-[100000] pointer-events-none"></div>
      )}

        ...
        >
            <div className="mb-6 flex items-start gap-4">
                <div className="w-12 h-12 md:w-16 md:h-16 shrink-0 bg-emerald-950/20 border border-emerald-500/50 p-1">
                    <img src="https://cik07-cos.7moor-fs2.com/im/4d2c3f00-7d4c-11e5-af15-41bf63ae4ea0/d19ea972df034757/byq.jpg" alt="Byaki" className="w-full h-full object-cover filter contrast-125 select-none" onContextMenu={(e) => e.preventDefault()} draggable={false} />
                </div>

...
export const chapterS002: Chapter = {
  id: "story-frag-rain-2",
  date: "档案记录: S-002",
  status: 'published',
  translations: {
    'zh-CN': {
      title: "那场仍未结束的零碎之雨 (二) // 揭露",
      summary: "厚重的气密门隔绝了通路，也锁住了那些关于“实验”的秘密。",
      content: `[[BLUE::记忆提取中... 场景重构：Nova Labs 内部实验室 - B区 (Sector B)]]
...
[[IMAGE::https://cdn.imgos.cn/vip/2026/01/02/6957e8e22304e.png::PHOTO_ARCHIVE_M001]]`
    ...
    'zh-TW': {
      title: "那場仍未結束的零碎之雨 (2) // 揭露",
      summary: "厚重的氣密門隔絕了通路，也鎖住了那些關於「實驗」的秘密。",
      content: `[[BLUE::記憶提取中... 場景重構：Nova Labs 內部實驗室 - B區 (Sector B)]]

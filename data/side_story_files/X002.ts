...
export const chapterX002: Chapter = {
  id: "story-quantum-delivery",
  date: "档案记录: X-002",
  status: 'published',
  translations: {
    'zh-CN': {
      title: "高维快递服务",
      summary: "零点试图证明“空间折跃”可以用于外卖配送，但收货地址似乎填错到了奇怪的地方。",
      content: `[[DIVIDER]]
...
泽洛：“（小声）某种意义上，这确实是‘高维’快递呢……”`
    },
    'zh-TW': {
      title: "高維快遞服務",
      summary: "零點試圖證明「空間折躍」可以用於外賣配送，但收貨地址似乎填錯到了奇怪的地方。",
      content: `[[DIVIDER]]

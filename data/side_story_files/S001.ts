...
export const chapterS001: Chapter = {
  id: "story-frag-rain-1",
  date: "档案记录: S-001",
  status: 'published',
  translations: {
    'zh-CN': {
      title: "那场仍未结束的零碎之雨 (一) // 废墟",
      summary: "废弃的校区，久违的吉他话题，以及掩盖在日常下的暗流。",
      content: `[[BLUE::记忆提取中... 场景重构：废弃校区]]
...
暮雨：“……哦？终于要聊工作了吗？走着！”`
    ...
    'zh-TW': {
      title: "那場仍未結束的零碎之雨 (1) // 廢墟",
      summary: "廢棄的校區，久違的吉他話題，以及掩蓋在日常下的暗流。",
      content: `[[BLUE::記憶提取中... 場景重構：廢棄校區]]

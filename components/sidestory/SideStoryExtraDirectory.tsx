...
import { ArrowLeft, AlertTriangle, Database, GitCommit, ShieldAlert, Cpu, Lock } from 'lucide-react';
...
const SideStoryExtraDirectory: React.FC<SideStoryExtraDirectoryProps> = ({ 
  ...
  return (
    <div className={`h-full overflow-y-auto p-4 md:p-12 relative flex flex-col items-center custom-scrollbar pb-24 landscape:pb-20 bg-[#05000a]`}>
        ...
        <div className="w-full max-w-4xl relative z-10 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row md:items-end gap-4 md:gap-6 mb-8 md:mb-12 border-b-2 border-fuchsia-900/50 pb-4 md:pb-8 relative landscape:mb-6">
                <button 
                    onClick={onBack}
                    className={`p-2 md:p-3 border-2 transition-all flex items-center gap-2 font-black font-mono text-[10px] md:text-xs uppercase group shadow-hard-sm border-fuchsia-900/50 text-fuchsia-400 hover:bg-fuchsia-900/40`}
                >
                ...
                <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1 md:mb-2">
                        <div className="flex -space-x-1">
                            ...
                            <StraightStar size={12} className="text-emerald-600 animate-ping" />
                        </div>
                        ...
                        <Reveal key={chapter.id} delay={index * 100} className={`${offset}`}>
                            ...
                            >
                                ...
                                <div className="pl-10 md:pl-14 relative z-10">
                                    <p className={`text-[10px] md:text-xs font-mono italic leading-relaxed line-clamp-1 md:line-clamp-2 ${isLocked ? 'text-ash-gray/50' : 'text-ash-gray'}`}>
                                        {isLocked ? '////////////////////////////////' : t.summary}
                                    </p>

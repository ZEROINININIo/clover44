...
export const chapterX003: Chapter = {
  id: "story-hotpot-protocol",
  date: "档案记录: X-003",
  status: 'published',
  translations: {
    'zh-CN': {
      title: "绝密火锅协议",
      summary: "实验室守则第一条：严禁在操作台附近饮食。除非……食材实在是太诱人了。",
      content: `[[DIVIDER]]
...
芷漓：“呼……好险。不过 Void 前辈，你看得到吃不到，是不是很气？如果你能像以前那样能摸得到就好了。。”

0000.2Void>>……我刚刚修改了你们的体重秤数据。祝用餐愉快。

零点：“啊啊啊！我的牛肉！都不许抢，我要化悲愤为食量！”`
    },
    'zh-TW': {
      title: "絕密火鍋協議",
      summary: "實驗室守則第一條：嚴禁在操作台附近飲食。除非……食材實在是太誘人了。",
      content: `[[DIVIDER]]
...
芷漓：「呼……好險。不過 Void 前輩，妳看得到吃不到，是不是很氣？如果妳能像以前那樣能摸得到就好了。。」
